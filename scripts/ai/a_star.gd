...
func path_search(start, goal):
    ...
    for id in path_found:
        path_translated.push_back(self._point_id_2_position(id))  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
...
func prepare_map_grid(abstract_map):
    ...
    for id in self.grid:
        field = abstract_map.get_field(self._point_id_2_position(id))  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
...
func _point_id_2_position(id):  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
    return self.grid[id][self.POSITION_KEY]

func _get_adjacent_tile_ids(tile_id):
    var ids = PoolIntArray([])  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
    var field
