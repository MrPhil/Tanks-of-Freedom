...
func _initialize():
    self.update_ai_speed_scale()  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
...
func update_ai_speed_scale():  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
    self.__set_ai_speed_scale(self.bag.root.settings['ai_speed'])  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review

func __set_ai_speed_scale(speed):  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
