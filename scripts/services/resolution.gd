...
func _initialize():
    ...
    self.override_resolution = ProjectSettings.get('tof/resolution_override')
...
func calculate_locked_height():
    self.locked_height = ProjectSettings.get('display/height')
...
func apply_resolution():
    ...
    if not self.override_resolution:
        var width = ProjectSettings.get('display/width')
        var height = ProjectSettings.get('display/height')
