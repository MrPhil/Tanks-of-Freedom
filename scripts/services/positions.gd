...
var TILES_LOOKUP_RANGES = PoolIntArray(range(1, 31))  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
...
func get_player_bunker_position(player):
    ...
    if bunker == null:
        return null
    return bunker.get_initial_position()  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
...
func get_nearby_tiles(position, lookup_range=CLOSE_RANGE):
    var tiles = PoolVector2Array([])  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
