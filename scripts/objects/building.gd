...
func get_spawn_point_position():  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
	return spawn_point
...
func set_frame(number):
	...
	var new_frame = Rect2(number * 64, current_frame.position.y, 64, 64)  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
