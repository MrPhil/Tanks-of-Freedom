...
func init_root(root_node):
	root = root_node
	stream_player = root.get_node("AudioStreamPlayer")  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
	stream_player.set_volume(self.music_volume)
	sample_player = root.get_node("Node")  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
