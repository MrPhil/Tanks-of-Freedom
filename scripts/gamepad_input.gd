...
func handle_input(event):
    if event is InputEventJoypadMotion:  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
        self.handle_motion(event)
    elif event is InputEventJoypadButton:  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
...
func move_selector(offset):
    ...
    if self.bag.workshop.is_working and not self.bag.workshop.is_suspended:
        ...
        self.bag.workshop.set_selector_map_position(new_position)  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
        self.bag.workshop.set_camera_map_position(new_position)  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
        if self.painting:
